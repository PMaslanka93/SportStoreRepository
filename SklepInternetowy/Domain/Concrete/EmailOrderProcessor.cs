...
namespace Domain.Concrete
{
    ...
    {
        public string MailToAddress = "pmaslanka.93@wp.pl";
        public string MailFromAddress = "pankay666@wp.pl";
    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessorOrder(Cart cart, ShoppingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                body.AppendFormat("Wartość całkowita: {0:c}", cart.CamputeTotalValue())
            .AppendLine("---")
